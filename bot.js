...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'X.help','Type X.help',`${client.users.size} Members`,'X.inv','By: SizGooo | Bomber','X.support','Version 0.0.1'];
    var i = -1;
    var j = 0;
