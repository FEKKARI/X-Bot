...
const devs = ['530011582910955521'];
const db = require('quick.db');
const premium = ['530011582910955521']
...
client.on('ready', function(){
    var ms = 60000 ;
    var setGame = [`${client.guilds.size} Server`,'G.help','Type G.help',`${client.users.size} Members`,'G.inv','By: SizGoooo | Bomber'];
    var i = -1;
    var j = 0;
